...
extension Font {
    ...
    static let size32Semibold       = Font.system(size: 32, weight: .semibold)
    ...
    static let size14Regular        = Font.system(size: 14, weight: .regular)
    ...
    static let size12Regular        = Font.system(size: 12, weight: .regular)
