...
struct InterviewFeedback: Equatable, Sendable, Hashable {
...
struct InterviewFeedbackQuestion: Equatable, Sendable, Hashable {
    let question: String
...
struct InterviewQuestionScore: Equatable, Sendable, Hashable {
    let overall: Int
    let clarity: Int
    let confidence: Int
    let pacing: Int
